...
input_path: Path = DATA_PATH / "text_data_sandra.txt"
...
unique_clean_tokens: int = len(set(clean_tokens))
print(f"Unique cleaned tokens: {unique_clean_tokens:,}")
...
plt.title("Top 15 Most Frequent Cleaned Tokens")
plt.xlabel("Token")
